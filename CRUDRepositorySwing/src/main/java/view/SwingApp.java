...
public class SwingApp extends JFrame {
    ...
    private void refreshEmployeeTable() {
        ...
        try {
            ...
            // Crear un model de table y establecer los datos del os empleados
            ...
            JOptionPane.showMessageDialog(this, "Errro al obtener los datos del empleado");
        }
    }
    ...
    private void agregarEmpleado() throws SQLException {
        ...
        if(result == JOptionPane.OK_OPTION) {
            // Crear un nuevo objeto Employee con los daos ingresados
            Employee employee = new Employee();
            employee.setFirst_name(nombreField.getText());
            employee.setPa_surname(apellidoPaternoField.getText());
            employee.setMa_surname(apellidoPaternoField.getText());
            ...
            JOptionPane.showMessageDialog(this, "Empleado agregado con exito", "Exito", JOptionPane.INFORMATION_MESSAGE);
        }
    }
            ...
            try {
                ...
                if(empleado != null) {
                    ...
                    if(confirmResult == JOptionPane.OK_OPTION) {
                        ...
                        empleado.setMa_surname(apellidoPaternoField.getText());
    ...
    private void eliminarEmpleado() throws SQLException {
        ...
        if(empleadoIdStr != null) {
            try {
                ...
                int confirmarResult = JOptionPane.showConfirmDialog(this, "¿Estas seguro de eliminar el empleado?", "Eliminar Empleado", JOptionPane.OK_CANCEL_OPTION);
                if (confirmarResult == JOptionPane.OK_OPTION) {
